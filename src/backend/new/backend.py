...
class Config:
    ...
    VECTOR_DB_PATH = "./archive/vector.jsonl"
    METADATA_PATH = "./archive/mongodb_law_collection_backup.json"
    TEST_DATA_PATH = "./archive/test_finetune_hn.jsonl"
    FEEDBACK_PATH = os.path.join(DATA_DIR, "feedbacks.jsonl")
    
    EMBEDDING_MODEL_PATH = r"C:\Users\HELLO\Documents\NLP\source code\source code\bge-m3-output\bge-m3-output"
    # LLM_NAME = "Qwen/Qwen2.5-0.5B-Instruct" 
    LLM_NAME = "Qwen/Qwen2.5-0.5B-Instruct" 
    DEVICE = "cuda" if torch.cuda.is_available() else "cpu"
    TOP_K_RETRIEVE = 10
    
    OUTPUT_EXCEL_PATH = "rag_legal_audit_final.xlsx"
...
class LegalCore:
    def __init__(self):
        ...
        # 2. Load Embedder
        self.embedder = BGEM3FlagModel(Config.EMBEDDING_MODEL_PATH, use_fp16=True, devices=[Config.DEVICE])
